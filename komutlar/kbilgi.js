...
exports.run = async (bot, msg, args) => {
    ...
    if (kurulus > 10) kontrol = 'Güvenilir'
      ...
      userinfo.status = user.presence.status.toString()
        .replace("dnd", `<:dnd:647055167178539050> Rahatsız Etmeyin`)
        .replace("online", `<:online:647055167144853525> Çevrimiçi`)
        .replace("idle", `<:idle:647055166549524480> Boşta`)
        .replace("offline", `<:offline:647055166402592789> Çevrimdışı`)  
