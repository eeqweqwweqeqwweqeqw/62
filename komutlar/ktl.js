exports.run = async (client, message) => {
  ...
  if (permissions.has("CONNECT") === false) { return message.channel.send("<:hayr:668070221667368960>Ses kanalınıza bağlanmak için yeterli izne sahip değilim. Giriş iznini kaçırdım."); }
